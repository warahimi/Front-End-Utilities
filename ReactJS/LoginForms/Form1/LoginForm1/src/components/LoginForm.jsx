...
const LoginForm = () => {
  return (
    <div className= 'bg-white px-10 py-20 rounded-2xl border-2 border-gray-200 shadow-2xl'>
        ...
        <h1 className='text-5xl font-semibold mb-8 text-center'>Welcome Back!</h1>
        <p className='text-lg font-medium text-gray-500 mb-5 text-center'>Please enter your details.</p>
        <div>                           {/**Inputs container */}
            <label htmlFor="email" className='text-base font-medium'>Email</label>
            <span className='text-violet-500 text-lg ml-2'><i class="fa-solid fa-envelope"></i></span>
            ...
            <span className='text-violet-500 text-lg ml-2'><i class="fa-solid fa-lock"></i></span>
        ...
        <div className='flex flex-col justify-center items-center gap-y-4 mb-8'>                           {/**Sign in and Sign up  */}
            <button className='bg-violet-500 text-white text-lg font-bold py-4 w-full rounded-2xl hover:scale-[1.02] active:scale-[0.98] transition-all ease-in-out focus:outline-2 focus:outline-offset-2 focus:outline-violet-200 focus:bg-violet-700'><span className='mr-2'><i class="fa-solid fa-user"></i></span>Sign in</button>
        ...
        <button className='w-full py-4 rounded-xl text-white font-bold text-lg mt-9 bg-violet-500 hover:bg-violet-600 focus:bg-red-400 focus:outline-7 focus:outline-offset-5 focus:outline-yellow-300'>Outline</button>
    </div>
  )
}
